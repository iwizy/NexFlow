...
Start with [CONTRIBUTING.md](CONTRIBUTING.md), then read [AGENTS.md](AGENTS.md). Changes that alter the model, manifests, schemas, or compatibility expectations should go through the RFC process.
