...
| Extension author | [Extension Model](extensions.md) -> [Extension Registry Model](extension-registry.md) -> [Extension Loading Boundary](extension-loading-boundary.md) -> [MCP And A2A Boundaries](mcp-a2a-boundaries.md) -> [MCP Extension Draft](../extensions/mcp/README.md) -> [A2A Extension Draft](../extensions/a2a/README.md) -> [Integrations](integrations.md) -> [Conformance](conformance.md) |
